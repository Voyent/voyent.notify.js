...
(function (v) {
    ...
    if (!v.notify) {
        ...
        notify = v.notify = {
            ...
            /**
             * @property {Number} queuePosition - The position of the currently active notification in the queue (readonly).
             * @default -1
             */
            _queuePosition: -1,
            ...
            removeCurrentNotification: function() {
                ...
                var cancelled = _fireEvent('beforeQueueUpdated',{"op":"del","notification":this.queue[this._queuePosition],"queue":this.queue.slice(0)},true);
                if (cancelled) {
                    return false;
                }
                //if we have an id it means the notification is stored in the
