if (typeof voyent === 'undefined' || typeof voyent.io === 'undefined' || typeof voyent.xio === 'undefined') {
    throw new Error('voyent.notify.js requires voyent.io.js and voyent.xio.js, please include these before voyent.notify.js');
}
...
(function (v) {
    ...
    function _removeNotificationFromMailbox(id) {
        ...
        v.io.mailbox.deleteMessages({"username":v.io.auth.getLastKnownUsername(),
    ...
    function _setupOnload() {
        ...
        function onload() {
            ...
            if (begIndexMailId > -1) {
                ...
                v.io.mailbox.findMessages({"username":v.io.auth.getLastKnownUsername(),"query":{"notificationId":notificationId}}).then(function(mail) {
                    if (mail && mail[0]) {
