    ...
    if (!v.notify) {
        ...
        notify = v.notify = {
            ...
            config: { //config options
                ...
                /**
                 * @property {string} title - Title/header text for each notification.
                 * @default ''
                 */
                _title:'',
                ...
                /**
                 * @property {string} icon - The URL of the image to use as an icon for Toast and Native notifications. Max-width of 40px.
                 * @default ''
                 */
                _icon:'',
            ...
            /**
             * Fired after the current notification is set. Not cancelable.
             ...
             * @param {number} index - The index of the notification in the queue.
             * @returns {Object} - The notification.
             */
             ...
             * notification and injects the notification data into the page.
             ...
             * @param {Object} notification - A Toast or Native notification reference.
