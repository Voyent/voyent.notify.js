...
(function (v) {
            ...
            startListening: function() {
                ...
                if (!_this._pushServiceStarted) {
                    v.push.startPushService({}).then(function () {
                        ...
                        console.log('Error when starting the push service: ', e)
                    });
                }
            ...
            joinGroup: function(group) {
                ...
                if (group && typeof group === 'string' &&
                    ...
                    v.push.addPushListener({
                        ...
                        console.log('Error when joining group:',error)
                    });
                }
            },
    ...
    var isInitialized = false; //Indicates if voyentNotifyInitialized has fired.
