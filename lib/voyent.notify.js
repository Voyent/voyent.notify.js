    ...
    if (!v.notify) {
        ...
        notify = v.notify = {
            ...
            startListening: function() {
                ...
                this.joinGroup(groupToJoin, true);
            },
             ...
             * @param noScoping true or false (default), if set will not append account+realm to group name
             */
            joinGroup: function(group, noScoping) {
                var _this = this;
