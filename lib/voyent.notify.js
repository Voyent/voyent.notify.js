...
(function (v) {
    ...
    function _setupListeners() {
        ...
        if (!_isInitialized) {
            ...
            console.log('begIndexMailId:',begIndexMailId);
            if (begIndexMailId > -1) {
    ...
    function _createToastChildren(toast,notification) {
        ...
        //add onclick listener with default behaviour of redirecting
        var clickNotification = function() {
        ...
        msgDiv.onclick = clickNotification;
        if (titleDiv) { titleDiv.onclick = clickNotification; }
        if (iconDiv) { titleDiv.onclick = clickNotification;}
