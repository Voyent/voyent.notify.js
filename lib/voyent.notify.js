    ...
    if (!v.notify) {
        ...
        notify = v.notify = {
            ...
            startListening: function() {
                ...
                this.joinGroup(v.auth.getLastKnownUsername(), true);
            },
            ...
            processNidFromUrl: function() {
                ...
                if (begIndexMailId > -1) {
                    nid = new RegExp( '[?&]' + VOYENT_MAIL_QUERY_PARAMETER + '=([^&#]*)', 'i' ).exec(params);
